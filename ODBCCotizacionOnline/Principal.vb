...
Module Principal
    ...
    Private Sub cargarF0014()


        ejecutarSQL("DELETE FROM F0014")

        Dim cnnAux As New Odbc.OdbcConnection(cadenaAS400)
        Dim rsAux As New Odbc.OdbcCommand("SELECT *  FROM F0014 where pnptc like 'W%'", cnnAux)
        ...
        Try
            ...
            While readerAux.Read()
                'ejecutarSQL("INSERT INTO F0014 ([PNPTC],[PNPTD],[PNDCP],[PNDCD],[PNNDTP],[PNDDJ],[PNNSP],[PNDTPA],[PNEIR],[PNUSER],[PNPID],[PNUPMJ],[PNJOBN],[PNUPMT],[PNPXDM],[PNPXDD]) VALUES ('" & readerAux("PNPTC") & "','" & readerAux("PNPTD") & "', '" & readerAux("PNDCP") & "','" & readerAux("PNDCD") & "','" & readerAux("PNNDTP") & "','" & readerAux("PNDDJ") & "','" & readerAux("PNNSP") & "','" & readerAux("PNDTPA") & "','" & readerAux("PNEIR") & "','" & readerAux("PNUSER") & "','" & readerAux("PNPID") & "','" & readerAux("PNUPMJ") & "','" & readerAux("PNJOBN") & "','" & readerAux("PNUPMT") & "','" & readerAux("PNPXDM") & "','" & readerAux("PNPXDD") & "' )")

                Dim valor As String

                'valor = readerAux.GetString(readerAux.GetOrdinal("PNPTC"))
                valor = readerAux("PNPTC")
    ...
    Private Function ejecutarSQL400(sql As String) As Boolean
